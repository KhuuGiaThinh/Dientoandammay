...
ROUTES = {
    ...
    "/api/foods": os.getenv("FOOD_SERVICE_URL", os.getenv("PRODUCT_SERVICE_URL", "http://food-order-service:5002")),
    "/api/products": os.getenv("FOOD_SERVICE_URL", os.getenv("PRODUCT_SERVICE_URL", "http://food-order-service:5002")),
    "/api/orders": os.getenv("ORDER_SERVICE_URL", "http://food-order-service:5002"),
    "/api/cart": os.getenv("ORDER_SERVICE_URL", "http://food-order-service:5002"),
}
